...
#'
#' \code{t_ae_oview} returns adverse events according to STREAM format AET02
#'
...
#'  pooled total population, default here is "All Patients".
#'
#'
...
#  )
  ...
  #rtabulate(dset, col_by = col_by, FUN = function(x) sum(x), format = "xx", row.name = "total number")
